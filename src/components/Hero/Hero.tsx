...
export default function Hero() {
  ...
  return (
    <div className={`container-hero ${state.darkmode ? "dark-bg-1" : "light-bg-1"}`}>
      ...
      >
        {"I believe in creative processes & lifelong learning. I am always curious for new best Technology and Practices."}
      </motion.h4>
      ...
      >
        <h3>{"Find out more"}</h3>
        <img src={require("../../assets/images/arrow.png")} alt="tempImage" />
      </motion.button>
    </div>
  );
}
